...
//        String url = "http://192.168.31.201:8088/update70/jsoninfo";
        String url = "http://192.168.161.226:8088//update70/jsoninfo";
        String savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/zhang.txt";
...
//                System.out.println("Onsuccess+" + info.result.getAbsolutePath());
                Log.i("zhang", info.result.getAbsolutePath());
            }

            @Override
            public void onFailure(HttpException e, String s) {
//                System.out.println("Onfailure");
                Log.i("zhang", "Onfailure");
            }
        });
    }
}
